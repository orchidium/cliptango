(function (exports) {
  ...
  var history = JSON.parse(localStorage.getItem("ws.videos.searchHistory")) || [];
  ...
  function addHistory(value) {
    if (searchboxInput.value !== "") {
      ...
      history.push(value);
      localStorage.setItem("ws.videos.searchHistory", JSON.stringify(history));
  ...
  function refreshList() {
    ...
    OrchidServices.get("webstore_metadata/profile_logs").then(function (
      ...
      history = JSON.parse(localStorage.getItem("ws.videos.searchHistory")) || [];
